...
│
├── 📊 ppt/
│   └── Docker-DevOps-Presentation.pptx
│
├── 📚 notes/
...
│   ├── 04-docker-images.md
│   ├── 05-docker-containers.md
│   ├── 06-dockerfile.md
│   ├── 07-docker-storage.md
│   ├── 08-docker-networking.md
│   ├── 09-docker-compose.md
│   ├── 10-docker-hub-registry.md
│   ├── 11-docker-security.md
│   ├── 12-docker-deployment.md
│   ├── 13-docker-ci-cd.md
│   └── 14-docker-troubleshooting.md
│
├── ⚡ cheatsheet/
│   ├── docker-commands.md
│   ├── dockerfile.md
...
│
├── 📝 Assignments/
│   ├── assignment-01-docker-basics/
│   ├── assignment-02-dockerfile/
│   ├── assignment-03-docker-compose/
│   ├── assignment-04-docker-networking/
│   ├── assignment-05-docker-deployment/
│   └── assignment-06-docker-project/
│
├── 📅 weekly-tasks/
│   ├── week-01-docker-basics/
│   ├── week-02-images-containers/
│   ├── week-03-dockerfile/
│   ├── week-04-storage-networking/
│   ├── week-05-docker-compose/
│   ├── week-06-docker-hub/
│   └── week-07-deployment/
│
└── 🎥 reference-videos/
